...
<div class="container">
  ...
  <div class="row">
    <div class="col-12 py-5">
      ...
      <h3>BTTC</h3>
      <form class="needs-validation" novalidate action="icon_bttc" method="get">
        <div class="row">
          <div class="input-group mb-3 pt-1 col-10">
            <input type="text" class="form-control" name="token" placeholder="Token Address">
          </div>
      ...
      <h3>HBAR</h3>
      <form class="needs-validation" novalidate action="icon_hbar" method="get">
        <div class="row">
          <div class="input-group mb-3 pt-1 col-10">
            <input type="text" class="form-control" name="token" placeholder="Token Address">
          </div>
      ...
      <h3>Syscoin</h3>
      <form class="needs-validation" novalidate action="icon_sys" method="get">
        <div class="row">
          <div class="input-group mb-3 pt-1 col-10">
            <input type="text" class="form-control" name="token" placeholder="Token Address">
          </div>
